...
export class ColorService {
  ...
  _allColorsUrl = environment.apiUrl+'/lamaderas/v1/Color/getColorList';
  _createColorsUrl = environment.apiUrl+'/lamaderas/v1/Color/addColor';
  _deleteColorsUrl = environment.apiUrl+'/lamaderas/v1/Color/deleteColor';
  _updateColorsUrl = environment.apiUrl+'/lamaderas/v1/Color/updateColor';
