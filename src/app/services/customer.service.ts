...
export class CustomerService {
  ...
  _allCustomersUrl = environment.apiUrl+'/lamaderas/v1/Customer/getAllCustomers';
  _getByIdCustomerUrl = environment.apiUrl+'/lamaderas/v1/Customer/getCustomerByCode';
  _deleteCustomerUrl = environment.apiUrl+'/lamaderas/v1/Customer/deleteCustomer';
